...
import de.loskutov.fb.detectors.samples.FindPrntlnSamplesTricky.Printer;
import de.loskutov.fb.test.DetectorsTest;

@DetectorUnderTest(value=FindPrintlnDetector.class, samples = { Printer.class })
@NoWarningsTest
public class TestFindPrintlnPrinter extends DetectorsTest {
    //
}
